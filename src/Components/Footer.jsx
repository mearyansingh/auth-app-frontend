    ...
    <footer className=" py-3 border-top shadow-lg d-flex align-items-center">
      <Container fluid>
        <div className='d-flex flex-wrap justify-content-between align-items-center'>
          <p className="col-md-4 mb-0 text-body-tertiary">Auth © {new Date().getFullYear()}</p>
          ...
          <p className='mb-0 '><small className='text-body-tertiary'>Made with</small> ❤️ <small className='text-body-tertiary pe-1'>by</small><a className=" text-dark fw-bold" href='https://devaryan.me'>devaryan</a></p>
        </div>
      </Container>
    </footer>
  )
